...
var (
	...
	OverridePatexBedrock = &flags.BigFlag{
		Name:     "override.bedrock",
		Usage:    "Manually specify PatexBedrock, overriding the bundled setting",
		Category: flags.EthCategory,
	}
	OverridePatexRegolith = &flags.BigFlag{
		Name:     "override.regolith",
		Usage:    "Manually specify the PatexRegolith fork timestamp, overriding the bundled setting",
		Category: flags.EthCategory,
	}
	OverridePatex = &cli.BoolFlag{
		Name:     "override.patex",
		Usage:    "Manually specify patex",
		Category: flags.EthCategory,
	}
