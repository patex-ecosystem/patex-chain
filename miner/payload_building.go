...
type BuildPayloadArgs struct {
	...
	NoTxPool     bool                 // Patex addition: option to disable tx pool contents from being included
	Transactions []*types.Transaction // Patex addition: txs forced into the block via engine API
	GasLimit     *uint64              // Patex addition: override gas limit of the block to build
}
