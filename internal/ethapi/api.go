...
func (s *BlockChainAPI) GetBalance(ctx context.Context, address common.Address, blockNrOrHash rpc.BlockNumberOrHash) (*hexutil.Big, error) {
	...
	if s.b.ChainConfig().IsPatexPreBedrock(header.Number) {
...
func (s *BlockChainAPI) GetHeaderByNumber(ctx context.Context, number rpc.BlockNumber) (map[string]interface{}, error) {
	...
	if header != nil && err == nil {
		...
		if number == rpc.PendingBlockNumber && s.b.ChainConfig().Patex == nil { // don't remove info if patex
...
func (s *BlockChainAPI) GetBlockByNumber(ctx context.Context, number rpc.BlockNumber, fullTx bool) (map[string]interface{}, error) {
	...
	if block != nil && err == nil {
		...
		if err == nil && number == rpc.PendingBlockNumber && s.b.ChainConfig().Patex == nil { // don't remove info if patex
...
func (s *BlockChainAPI) CreateAccessList(ctx context.Context, args TransactionArgs, blockNrOrHash *rpc.BlockNumberOrHash) (*accessListResult, error) {
	...
	header, err := headerByNumberOrHash(ctx, s.b, bNrOrHash)
	if err == nil && header != nil && s.b.ChainConfig().IsPatexPreBedrock(header.Number) {
		if s.b.HistoricalRPCService() != nil {
...
func (s *TransactionAPI) GetTransactionReceipt(ctx context.Context, hash common.Hash) (map[string]interface{}, error) {
	...
	if s.b.ChainConfig().Patex != nil && !tx.IsDepositTx() {
		fields["l1GasPrice"] = (*hexutil.Big)(receipt.L1GasPrice)
		fields["l1GasUsed"] = (*hexutil.Big)(receipt.L1GasUsed)
		fields["l1Fee"] = (*hexutil.Big)(receipt.L1Fee)
		fields["l1FeeScalar"] = receipt.FeeScalar.String()
	}
	if s.b.ChainConfig().Patex != nil && tx.IsDepositTx() && receipt.DepositNonce != nil {
